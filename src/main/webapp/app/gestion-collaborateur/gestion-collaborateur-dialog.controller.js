(function() {
    ...
    angular
        ...
        .controller('GestionCollaborateurDialogController', GestionCollaborateurDialogController);

    GestionCollaborateurDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Collaborateur', 'Rubrique', 'Email', 'Adresse', 'Fonction', 'Classification', 'Formation', 'Publication', 'Diplome', 'Experience', 'Cv', 'Competence'];

    function GestionCollaborateurDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Collaborateur, Rubrique, Email, Adresse, Fonction, Classification, Formation, Publication, Diplome, Experience, Cv, Competence) {
        var vm = this;
