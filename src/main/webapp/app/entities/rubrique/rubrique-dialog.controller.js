(function() {
    ...
    RubriqueDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Rubrique', 'Collaborateur', 'Cv'];

    function RubriqueDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Rubrique, Collaborateur, Cv) {
        var vm = this;
