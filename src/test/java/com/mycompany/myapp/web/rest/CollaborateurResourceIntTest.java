...
public class CollaborateurResourceIntTest {
    ...
    private static final String DEFAULT_COLLABORATEUR_SEXE = "AAAAA";
    private static final String UPDATED_COLLABORATEUR_SEXE = "BBBBB";
    private static final String DEFAULT_COLLABORATEUR_ETAT_MARITAL = "AAAAA";
    private static final String UPDATED_COLLABORATEUR_ETAT_MARITAL = "BBBBB";
    private static final String DEFAULT_COLLABORATEUR_NOMBRE_ENFANT = "AAAAA";
    private static final String UPDATED_COLLABORATEUR_NOMBRE_ENFANT = "BBBBB";
    ...
    public void getAllCollaborateurs() throws Exception {
        ...
        restCollaborateurMockMvc.perform(get("/api/collaborateurs?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].collaborateurNombreEnfant").value(hasItem(DEFAULT_COLLABORATEUR_NOMBRE_ENFANT.toString())))
    ...
    public void getCollaborateur() throws Exception {
        ...
        restCollaborateurMockMvc.perform(get("/api/collaborateurs/{id}", collaborateur.getId()))
            ...
            .andExpect(jsonPath("$.collaborateurNombreEnfant").value(DEFAULT_COLLABORATEUR_NOMBRE_ENFANT.toString()))
